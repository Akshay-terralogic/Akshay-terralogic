        ...
        <div class="col-md-12"> 
          <div class="zw-heading-container pb-md-5 pt-4 pb-4">
            <ul class="nav nav-pills" id="pills-tab" role="tablist">
              ...
              <li class="nav-item" role="presentation">
                <a class="nav-link active" href="<?php echo get_site_url(); ?>/blog/">Blogs</a>
              </li>
              <li class="nav-item" role="presentation">
          ...
          <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab"> 
                      ...
                      <?php if($query->have_posts()) : ?>
                        <?php while($query->have_posts()) : $query->the_post();?>
                          ...
                          <a class="text-decoration-none" href="<?php the_permalink(); ?>">
                            <div class="img"> 
                              <img src="<?php echo get_the_post_thumbnail_url(); ?>" alt="blog1">
                            </div>
                            <div class="info"> 
              ...
              <div class="section-latest-blog zw-section-paddingb90"> 
                <div class="row"> 
                  <div class="col-md-12"> 
                    <div class="d-flex justify-content-between align-items-center mb-4 pb-md-2">
                      <form id="filters" action="<?php echo site_url() ?>/wp-admin/admin-ajax.php" method="POST">
                    ...
                    <div class="js-resources-cards swiper-container"> 
                      <div class="row swiper-wrapper" id="posts_wrap">
                      <?php
                        $args = array(
                          'post_type' => 'post',
                          'posts_per_page' => -1,
