...
**********************************
*
  =Change Dropdown Menu Class
*
**********************************
*/
function dropdown_submenu_class($menu) {
  $menu = preg_replace('/ class="sub-menu"/','/ class="menu menu--dropdown" /',$menu);  
  return $menu;  
}
add_filter('wp_nav_menu','dropdown_submenu_class'); 

/**
*****************************************
*
  =Add Class to menu-item-has-children
*
*****************************************
*/
...
function add_has_children_to_nav_items($items){
  ...
  in_array( $item->ID, $parents ) && $item->classes[] = 'ui dropdown';
  return $items;
}